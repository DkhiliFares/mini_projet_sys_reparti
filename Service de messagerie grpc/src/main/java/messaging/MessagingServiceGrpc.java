...
public final class MessagingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<messaging.MessageOuterClass.Message,
      messaging.MessageOuterClass.Message> getSendMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendMessage",
      requestType = messaging.MessageOuterClass.Message.class,
      responseType = messaging.MessageOuterClass.Message.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<messaging.MessageOuterClass.Message,
      messaging.MessageOuterClass.Message> getSendMessageMethod() {
    io.grpc.MethodDescriptor<messaging.MessageOuterClass.Message, messaging.MessageOuterClass.Message> getSendMessageMethod;
      ...
      synchronized (MessagingServiceGrpc.class) {
        if ((getSendMessageMethod = MessagingServiceGrpc.getSendMessageMethod) == null) {
          MessagingServiceGrpc.getSendMessageMethod = getSendMessageMethod = 
              io.grpc.MethodDescriptor.<messaging.MessageOuterClass.Message, messaging.MessageOuterClass.Message>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "messaging.MessagingService", "SendMessage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  messaging.MessageOuterClass.Message.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<messaging.MessageOuterClass.Message,
      messaging.MessageOuterClass.Message> getGetMessagesForUserMethod;
  ...
  public static io.grpc.MethodDescriptor<messaging.MessageOuterClass.Message,
      messaging.MessageOuterClass.Message> getGetMessagesForUserMethod() {
    io.grpc.MethodDescriptor<messaging.MessageOuterClass.Message, messaging.MessageOuterClass.Message> getGetMessagesForUserMethod;
  ...
  public static abstract class MessagingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sendMessage(messaging.MessageOuterClass.Message request,
        io.grpc.stub.StreamObserver<messaging.MessageOuterClass.Message> responseObserver) {
      asyncUnimplementedUnaryCall(getSendMessageMethod(), responseObserver);
    }

    /**
     */
    public void getMessagesForUser(messaging.MessageOuterClass.Message request,
        io.grpc.stub.StreamObserver<messaging.MessageOuterClass.Message> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                messaging.MessageOuterClass.Message,
                messaging.MessageOuterClass.Message>(
  ...
  public static final class MessagingServiceBlockingStub extends io.grpc.stub.AbstractStub<MessagingServiceBlockingStub> {
    ...
    /**
     */
    public messaging.MessageOuterClass.Message sendMessage(messaging.MessageOuterClass.Message request) {
    ...
    /**
     */
    public java.util.Iterator<messaging.MessageOuterClass.Message> getMessagesForUser(
        messaging.MessageOuterClass.Message request) {
  ...
  public static final class MessagingServiceFutureStub extends io.grpc.stub.AbstractStub<MessagingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<messaging.MessageOuterClass.Message> sendMessage(
        messaging.MessageOuterClass.Message request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_MESSAGE:
          serviceImpl.sendMessage((messaging.MessageOuterClass.Message) request,
              (io.grpc.stub.StreamObserver<messaging.MessageOuterClass.Message>) responseObserver);
          break;
        case METHODID_GET_MESSAGES_FOR_USER:
          serviceImpl.getMessagesForUser((messaging.MessageOuterClass.Message) request,
              (io.grpc.stub.StreamObserver<messaging.MessageOuterClass.Message>) responseObserver);
          break;
        default:
  ...
  private static abstract class MessagingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return messaging.MessageOuterClass.getDescriptor();
    }
